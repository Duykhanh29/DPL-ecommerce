...
class AddLegalInfo extends StatefulWidget {
  ...
  @override
  State<AddLegalInfo> createState() => __AddLegalInfoState();
}

class __AddLegalInfoState extends State<AddLegalInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    final shop = manageSellerProvider.shop;
            ...
            if (_formKey.currentState!.validate()) {
              if (taxPaperName == null || taxPaperPath == null) {
                ...
                VerificationForm verificationForm = VerificationForm(
                    sellerID: manageSellerProvider.seller!.id!,
                    contactAddress: manageSellerProvider
                        .seller!.userInfor!.sellerInfor!.contactAddress,
                    email: manageSellerProvider.seller!.email,
                    homeNumber: homeNumberController.text,
                    phoneNumber: phoneNumberController.text,
                    shopID: manageSellerProvider.shop!.id,
                    shopName: manageSellerProvider.shop!.name,
                    licenseNo: lisenceController.text);
                manageSellerProvider.setLegalInfo(
                    name: taxPaperName!,
                    newFile: _image!,
                    path: taxPaperPath!,
